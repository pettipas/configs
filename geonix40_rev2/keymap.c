...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_tkl_ansi(
        ...
        KC_LCTL, MO(3),   KC_LALT, KC_LGUI,  MO(1),           KC_SPC,   MO(2),   KC_LEFT,  KC_DOWN, KC_UP,  KC_RGHT
    ),
    [1] = LAYOUT_tkl_ansi(
        KC_TAB,  KC_1,    KC_2,    KC_3,   KC_4,   KC_5,      KC_6,     KC_7,      KC_8,      KC_9,      KC_0,     KC_BSPC,
        KC_DEL,  KC_NO,   KC_NO,   KC_NO,  KC_NO,  KC_NO,     KC_LEFT,  KC_DOWN,   KC_UP,     KC_RIGHT,  KC_HOME,  KC_END,
        KC_LSFT, KC_NO,   KC_NO,   KC_NO,  KC_NO,  KC_NO,     KC_NO,    KC_NUHS,   KC_NUBS,   KC_PGUP,   KC_PGDN,  KC_NO,
        KC_LCTL, KC_NO,   KC_NO,   KC_NO,  KC_NO,       KC_SPC,     KC_NO,   KC_MNXT,   KC_VOLD,   KC_VOLU,  KC_MPLY
    ),
    [2] = LAYOUT_tkl_ansi(
    ...
    [3] = LAYOUT_tkl_ansi(
        ...
        KC_NO,   KC_NO,  KC_LCTL,   KC_LGUI,  KC_NO,               U_EE_CLR, KC_NO, KC_EQL,  RGB_SPD,  RGB_VAD,  RGB_SPI
    )
};
